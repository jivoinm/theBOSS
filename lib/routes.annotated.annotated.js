...
module.exports = function (app) {
    ...
    app.get('/api/notes', requiresAuth, api.notes);
    app.post('/api/notes', requiresAuth, api.createNote);
    app.post('/api/notes/:id', requiresAuth, api.updateNote);
    app.delete('/api/notes/:id', requiresAuth, api.deleteNote);
    ...
    app.post('/api/users/:id/:role', users.updateRole);
    app.put('/api/users', requiresAuth, users.changePassword);
    app.get('/api/users', requiresAuth, users.query);
    ...
    app.patch('/api/orders/:id/calendar_update_date/:property/:date',requiresAuth, orders.updateCalendarDate);
    ...
    app.get('/api/orders/shippingList',requiresAuth,orders.shippingList);
